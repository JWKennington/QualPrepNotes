...
% 
\eqn{\Theta = \int_{r_{\text{min}}}^{\infty}\frac{\wrap{b/r^2}dr}{\sqrt{1 - \wrap{b^2/r^2} - \wrap{U/T_0'}}}}
...
include the case that $\theta = \psi$ and $m_1 << m_2$ then $\sigma(\psi) \approx \sigma(\theta)$
% 	Rutherford
Scattering of charged particles in a Coulomb field
\eqn{\sigma(\theta) = \frac{k^2}{\wrap{4T_0'}^2}\cdot\frac{1}{\sin^4{\wrap{\theta/2}}}}
