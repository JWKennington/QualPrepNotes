...
\eqn{\wrap{\frac{d\vec{Q}}{dt}}_{\text{fixed}} = \wrap{\frac{d\vec{Q}}{dt}}_{\text{rotating}} + \vec{\omega}\times\vec{Q}}
\eqn{\vec{v}_f = \vec{V} + \vec{v}_r + \vec{\omega}\times\vec{r}}
% Centrifugal and Coriolis Forces
\subsection{Centrifugal and Coriolis Forces}
Paragraph about derivation, with different terms listed inline
...
Paragraph about deflection effects, drift to right of velocity vector in Northern Hemisphere
