...
The simplest example is two spring oscillators with coefficient $\kappa$ connected by a spring with a different spring constant $\kappa_{12}$, illustrated in Fig. \ref{fig:cm-coupled-setup}.
\eqn{\begin{split}
...
\noindent Normal coordinates for the system can be found
\eqn{\begin{split}
	\eta_1 &\equiv x_1 - x_2\\
	\eta &\equiv x_1 + x_2
...
\end{split}}
% frequency splitting
Note that the effect of the ... is to split the natural frequency
% weak coupling
