...
abc
\eqn{\Lag=\frac{1}{2}\mu \left\lvert\dot{\vec{r}}\right\rvert^2 - U(r) \where\mu = \frac{m_1 m_2}{m_1 + m_2}\quad \text{and}\ r = \lvert\vec{r_2} - \vec{r_1}\rvert}

% Lagrangian
In terms of the CM frame, Lagrangian
...
\eqn{E = T + U = \text{constant} = \half\mu \dot{r}^2 + \half \frac{l^2}{\mu r^2} + U(r)}
...
\eqn{\dot{r} = 0 \implies E - U(r) - \frac{l^2}{2\mu r^2} = 0}

can have 2 solns, $r_{\text{min}}$, $r_{\text{max}}$ or a single solution - circular.

% Effective potential
Effective potential, fictitious
\eqn{V(r) = U(r) + \frac{l^2}{2\mu r^2}}


\subsection{Kepler's Laws}
% Kepler's parameterization of the problem - eccentricity
Kepler parameterization, k comes from central potential $U(r) = -\frac{k}{r}$
\eqn{\frac{\alpha}{r} = 1 + \varepsilon \cos{\theta}\where \alpha\equiv \frac{l^2}{\mu k},\quad \varepsilon \equiv \sqrt{q + \frac{2El^2}{\mu k^2}}}

% Orbital morphology
Orbital morphology (insert diagram 8-8), list cases in table Hyperbola, Parabola, Ellipse, Circle
For elliptical orbits, major and minor axes can be defined
...
% Kepler's laws
Kepler Laws
\eqn{\tau^2 = \frac{4\pi^2 \mu}{k}\alpha^3}
